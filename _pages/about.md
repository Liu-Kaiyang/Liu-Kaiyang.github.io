...
- <b>Network Intelligence for Next-generation Cloud Computing</b>. Next-generation cloud computing and Artificial Intelligence (AI) are playing pivotal roles in shaping and propelling the digital economy to new heights. Powered by AI techniques, cloud computing is expected to emerge as a data-centric, intelligent platform to deal with next-generation applications and workloads, e.g., digital twin, Internet of Things (IoT), and augmented/virtual reality. On the other hand, cloud computing has been considered a foundational enabler for AI innovation and deployment. The scalability, accessibility, and cost-efficiency of cloud computing make it an ideal platform for AI development, while AI, in turn, drives the demand for more advanced cloud services and capabilities. This mutually reinforcing relationship represents a dynamic force in the technology landscape, offering unprecedented opportunities and challenges. First, existing AI techniques, primarily originating from computer vision and natural language processing domains, raise new concerns such as high overhead, slow convergence, and poor performance over unforeseen conditions when applied to the network optimization domain. On the other hand, cloud computing was initially designed to achieve dependable resource sharing without tailored optimization for specific applications. How to improve the existing network architecture and protocol stack of cloud computing to better align with the requirements of AI applications is also a critical challenge.
    
- <b>Application-aware Cloud Networking</b>. Today's cloud networks are primarily designed around a traditional philosophy that emphasizes generality over optimality. This approach works for many current applications because most can tolerate networks that provide adequate throughput and reasonable delays, even without strict guarantees. Consequently, cloud networks have typically been designed using a ``best-effort" service model that supports a wide variety of applications, treating them equally regardless of their specific needs. However, two key trends are challenging this design. First, emerging delay-sensitive applications like tactile Internet, remote healthcare, virtual reality, and augmented reality require ultra-low latency and cannot function optimally within general-purpose networks. Second, the rise of specialized workloads, such as machine learning and GPU-based tasks, has spurred demand for customized infrastructures tailored to specific application requirements. Studies reveal significant performance variability in current cloud networks, with network bandwidth and packet delays between virtual machines differing drastically, especially for ultra-low latency applications. For example, Google's study shows that the 99.9th percentile of packet delay can be an order of magnitude higher than the median across cloud providers. Given these challenges, we propose an application-aware cloud networking design philosophy. By focusing on network resource management, scheduling, and congestion detection, we aim to build service-oriented, multi-tenant cloud networks optimized for specific applications. In particular, we explore AI/ML workloads and integrate solutions with communication libraries like NVIDIA’s NCCL to enhance parallel task execution, improving performance without altering application code.

- <b>Low-Earth-Orbit Satellite (LEOS)-based Space Cloud/Edge Computing</b>. In recent years, the concept of LEOS-based space edge computing has captured the imagination of technology enthusiasts and industry experts alike,  as seen in initiatives like Lumen Orbit and AI Sweden Space Edge. The idea of hosting data storage and processing facilities in outer space presents a compelling vision of the future, promising unparalleled scalability, energy efficiency, and reduced latency, benefiting a wide range of applications, from financial transactions to real-time communication and remote sensing. My previous research focuses on the design and analysis of distributed optimization and artificial intelligence solutions that span across cloud/edge networks, data center networks, and satellite communication networks to meet the stringent requirements arising from data-intensive applications. Among my most significant contributions are novel solutions in computing task scheduling, data placement, and caching to achieve high efficiency, low overhead, and scalability. These solutions should be revisited to ensure low latency, high throughput, and network resilience under varying traffic conditions and satellite configurations for future LEO satellite data centers. Deploying a coast-to-coast-to-coast LEO satellite networks (LSNs) testbed can help us further our understanding about the potential challenges and opportunities associated with space-based data centers.

**Research Fundings**
  
- <a href="https://www.nserc-crsng.gc.ca/">NSERC</a> Discovery Grants and Discovery Launch Supplement

- <a href="https://www.nserc-crsng.gc.ca/">NSERC</a> Research Tools and Instruments (RTI)
